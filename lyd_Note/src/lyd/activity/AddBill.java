...
import lyd.dao.GridViewAdapter;
...
public class AddBill extends Activity implements OnClickListener {
	...
	private void initView() {
		img = new Integer[] { R.drawable.star, R.drawable.table_money, R.drawable.snacks,
	...
	private void incomeIsClick() {
		img = new Integer[] { R.drawable.salary, R.drawable.part_time_job, R.drawable.bonus,
